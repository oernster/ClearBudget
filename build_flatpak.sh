...
modules:
  ...
  - name: clearbudget
    ...
    build-commands:
      ...
      - cp ClearBudget_256.png /app/share/clearbudget/ClearBudget_256.png
      - cp bank-icon.png bank-icon2.png creditcards2.png exporttohtml.png switchbudget.png opendb.png savedb.png information.png archive.png recommendations.png reserves.png exportpackage.png lightmode.png darkmode.png /app/share/clearbudget/
