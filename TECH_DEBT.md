...
- The four source and test files between 351 and 380 lines. Under the cap, clear of the 381 to 399 danger band, nothing to do. Both halves of that rule are asserted in `tests/structural/test_loc_limits.py`, so this is held by the suite rather than by eye.
